...
namespace Tests
{
	...
	void CreateCapsule(Game* game, double radius, double halfHeight, double mass, const dVec3& position, const dQuat& rotation, const fVec3& diffuse, const fVec3& specular);
