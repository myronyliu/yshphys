...
Polygon Sphere::IntersectPlane(const dVec3& pos, const dQuat& rot, const dVec3& planeOrigin, const dVec3& planeNormal, const dVec3& xAxis, const dVec3& yAxis) const
{
	Polygon poly;
...
Polygon Sphere::IntersectPlaneLocal(const dVec3& planeOrigin, const dVec3& planeNormal, const dVec3& xAxis, const dVec3& yAxis) const
{
	Polygon poly;
	poly.AddVertex(dVec2(0.0, 0.0));
	return poly;
