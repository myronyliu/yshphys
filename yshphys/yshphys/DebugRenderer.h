...
public:
	...
	void DrawTriangle(const fVec3& A, const fVec3& B, const fVec3& C, const fVec3& color, bool wireFrame, bool shaded = true);
	void DrawPolygon(const fVec3* verts, int nVerts, const fVec3& color, bool wireFrame, bool shaded = true);
	void DrawBox(float halfDimX, float halfDimY, float halfDimZ, const fVec3& pos, const fQuat& rot, const fVec3& color, bool wireFrame, bool shaded = true);
	void DrawCone(const fVec3& tip, const fVec3& base, const float& radius, const fVec3& color, bool shaded = true);
...
protected:
	...
	void DrawPolygon(const fVec3* verts, int nVerts, const fVec3& pos, const fQuat& rot, const fVec3& color, bool wireFrame, bool shaded = true);
};
